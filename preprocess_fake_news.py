...
def load_datasets(true_path=r'D:\fake_news_detection\data\True.csv', false_path=r'D:\fake_news_detection\data\False.csv'):
    """
...
def preprocess_dataset(df):
    ...
    try:
        ...
        if 'title' in df.columns and 'text' in df.columns:
            ...
            print("Error: No 'title' or 'text' column found in dataset.")
            return None
...
def main(true_path=r'D:\fake_news_detection\data\True.csv', false_path=r'D:\fake_news_detection\data\False.csv', output_path=r'D:\fake_news_detection\processed_data.csv'):
    """
    Main function to preprocess the fake news dataset.
    """
    try:
        # Load datasets
